...
func testSweepComputeRegionTargetTcpProxy(region string) error {
	...
	listTemplate := strings.Split("https://compute.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/targetTcpProxies", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://compute.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/targetTcpProxies/{{name}}"
